...
class Resume {
  ...
  mark(x, y, size) {
    ...
    this.ops.push(
      ...
      `${pt(98.5, 92.5)} l`,
      `${pt(105.473, 92.5)} ${pt(111.125, 86.848)} ${pt(111.125, 79.875)} c`,
      `${pt(111.125, 72.902)} ${pt(105.473, 67.25)} ${pt(98.5, 67.25)} c`,
      `${pt(84.0, 67.25)} l`,
      `${pt(77.027, 67.25)} ${pt(71.375, 61.598)} ${pt(71.375, 54.625)} c`,
      `${pt(71.375, 47.652)} ${pt(77.027, 42.0)} ${pt(84.0, 42.0)} c`,
      `${pt(108.0, 42.0)} l S`,
      'Q'
    );
  }
